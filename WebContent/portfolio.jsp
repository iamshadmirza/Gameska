    ...
    <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="portfolio.jsp">Best Of</a></li>
                    <li class="dropdown">
        ...
        <div class="section">
	    	<div class="container">
				<div class="row">
				<div class="col-sm-12">
						<h2>Top 6 Highest Rated Games of 2017</h2>
						<h3>These are the games that you need to buy right now.</h3>
						<p>
        ...
        <div class="section">
			...
			<ul class="grid cs-style-2">
	        	<div class="col-md-4 col-sm-6">
					<figure>
						<img src="img/portfolio/7.jpg" alt="img04">
						<figcaption>
							<h3>Prey</h3>
							<span>Exclusive</span>
				...
				<div class="col-md-4 col-sm-6">
					<figure>
						<img src="img/portfolio/8.jpg" alt="img03">
						<figcaption>
							<h3>Mass Effect 3</h3>
							<span>Exclusive</span>
							<a href="portfolio-item.jsp">Take a look</a>
				...
				<div class="col-md-4 col-sm-6">
					<figure>
						...
						<figcaption>
							<h3>Assassin's Creed Collection</h3>
							<span>Exclusive</span>
							<a href="portfolio-item.jsp">Take a look</a>
						</figcaption>
					</figure>
