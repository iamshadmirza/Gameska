...
h1{color:#aec62c;font-family: Consolas;}
...
<header class="navbar navbar-inverse navbar-fixed-top" role="banner">
		...
		<div class="section section-breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<h1>Welcome <%=session.getAttribute("LUN")%></h1>
					</div>
				</div>
			</div>
		</div>
		<br>
		<form action="userview.jsp" method=post id="users">
		<h3>Manage Users :</h3> <button type="submit" value="user">View Users</button>
		</form>
		<br>
		<form action="adminview.jsp" method=post id="admins">
		<h3>Manage Admins :</h3> <button type="submit" value="admin">View Admins</button>
		</form>
		<br>
		<form action="logout.jsp" method=post id="Logoutt">
		<h3>End Session :</h3><button type="submit" value="Logout">Logout</button>
		</form>
